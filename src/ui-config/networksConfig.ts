...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  ...
  [6969696969]: {
    name: 'Magma',
    // isTestnet: true,
    privateJsonRPCUrl: 'https://turbo.magma-rpc.com',
    publicJsonRPCUrl: ['https://turbo.magma-rpc.com'],
    // publicJsonRPCWSUrl: 'wss://bsc.publicnode.com',
    baseAssetSymbol: 'LAVA',
    wrappedBaseAssetSymbol: 'WLAVA',
    baseAssetDecimals: 18,
    explorerLink: 'https://www.magmascan.org',
    networkLogoPath: '/icons/networks/magma.svg',
    ratesHistoryApiUrl,
  },
  // [ChainId.sepolia]: {
